# -*- coding: utf-8 -*-
import sys
from PySide.QtGui import QApplication, QWidget, QComboBox, QFontComboBox,QLineEdit,\
...
class Demo(QWidget):
    ...
    def __init__(self):
        ...
        #实例化一个QComboBox和QFontComboBox前者是普通的下拉框，框里是没有内容的，需要添加
    ...
    def combobox_init(self):
        ...
        #addItem()方法是添加一个选项，而addItems()接收一个可循环参数，这里传入了列表self.choice_list；
        self.combobox_1.currentIndexChanged.connect(lambda:self.on_combobox_func(self.combobox_1))
        #self.combobox_1.currentTxetChanged.connect(lambda:self.on_combobox_func(self.combobox_1))
        self.combobox_2.currentIndexChanged.connect(lambda:self.on_combobox_func(self.combobox_2))
        #self.combobox_2.currentTxetChanged.connect(lambda:self.on_combobox_func(self.combobox_2))
    ...
    def on_combobox_func(self,combobox):
        ...
        # 在自定义的槽函数中，我们通过判断combobox的种类，若是self.combobox_1的话，
        #则出现信息框，并且显示当前文本和及文本序号，currentIndex()方法获取当前文本序号
